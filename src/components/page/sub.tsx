...
export default (props: { app: typeof app, main: typeof main, sub: typeof sub }): JSX.Element | string => {
  return app.refer.router.query.listId && app.refer.router.query.mainId && (
    <div
      data-id="SubRoot"
      data-testid="SubRoot"
      ...
      >
        ...
        >
          ...
          <InputTextbox
            ...
            value={ props.main.state.data[app.refer.router.query.listId].data[app.refer.router.query.mainId].title }
            onInput={(e) => props.main.handle.inputValue({ mainId: app.refer.router.query.mainId, type: `title`, value: (e.target as HTMLInputElement).value })}
          />
          <IconMode
            data-testid="SubMode"
            className="flex-initial"
            onClick={() => props.main.handle.inputValue({ mainId: app.refer.router.query.mainId, type: `task`, value: !props.main.state.data[app.refer.router.query.listId].data[app.refer.router.query.mainId].task })}
          />
        </div>
        <div data-testid="SubBody" className="flex-1 overflow-auto p-3">
          { !props.main.state.data[app.refer.router.query.listId].data[app.refer.router.query.mainId].task ?
            <InputTextarea
              data-testid="SubMemo"
            ...
            <ul data-id="SubBody" className="anime-fade-item">
              { props.sub.state.data[app.refer.router.query.listId].data[app.refer.router.query.mainId].sort.map((subId, index) =>
                <li
                  key={subId}
                ...
                >
                  <InputCheck
                    ...
                    checked={ props.sub.state.data[app.refer.router.query.listId].data[app.refer.router.query.mainId].data[subId!].check }
                  ...
                  <InputTextarea
                    ...
                    sizing="content"
                    value={ props.sub.state.data[app.refer.router.query.listId].data[app.refer.router.query.mainId].data[subId!].title }
        ...
        >
          <InputTextbox
            ...
            value={ props.main.state.data[app.refer.router.query.listId].data[app.refer.router.query.mainId].date }
          ...
          <InputTextbox
            ...
            value={ props.main.state.data[app.refer.router.query.listId].data[app.refer.router.query.mainId].time }
