...
export default (props: { app: typeof app, list: typeof list, main: typeof main, children?: React.ReactNode }): JSX.Element | string => {
  return app.refer.router.query.listId && (
    <div
    ...
    >
      ...
      >
        ...
        <InputTextbox
          ...
          value={ props.list.state.data.data[app.refer.router.query.listId].title }
          onInput={(e) => props.list.handle.inputValue({ listId: app.refer.router.query.listId, type: `title`, value: (e.target as HTMLInputElement).value })}
        />
      ...
      <ul data-id="MainBody" data-testid="MainBody" className="flex-1 select-none overflow-auto p-3">
        { props.main.state.data[app.refer.router.query.listId].sort.map((mainId) =>
          <li
            key={mainId}
          ...
          >
            <InputCheck
              ...
              checked={ props.main.state.data[app.refer.router.query.listId].data[mainId].check }
            ...
            <div data-testid="MainTask" className="line-clamp-1 flex-1">
              { props.main.state.data[app.refer.router.query.listId].data[mainId].title }
            </div>
            <div
